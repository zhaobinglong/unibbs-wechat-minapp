...
// {
	...
	// {
		 ...
		 */
		function getPinyin (chinese, splitter, withtone, polyphone)
		{
		...
		function getFirstLetter(str, polyphone)
		{
			...
			if(this.dict.firstletter) // 使用首字母字典文件
			{
				...
				for(var i=0; i<str.length; i++)
				{
					...
					{   
						ch = this.dict.firstletter.pinyin_dict_firstletter.all.charAt(unicode-19968);
						if(polyphone) ch = this.dict.firstletter.pinyin_dict_firstletter.polyphone[unicode] || ch;
					}
					result.push(ch);
				}
...
module.exports = {
	 ...
	 parseDict:parseDict,
	 handlePolyphone:handlePolyphone,
	 dict:dict
}
// })();